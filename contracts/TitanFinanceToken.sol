...
contract TitanFinanceToken is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 1 * 10**9 * 10**9; // Max Transaction: 1 bilion (1%)
    ...
    uint256 public _maxWalletToken = 3 * 10**9 * 10**9; // Max Wallet: 3 bilion (3%)

    IPancakeRouter02 public pcsV2Router;
    address public pcsV2Pair;

    string private _name = "TitanFinanceToken";
